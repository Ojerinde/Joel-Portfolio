...
const ProjectsBank: ProjectsObj[] = [
  ...
  },
  {
    ...
    stacks: ["javascript", "github", "react"],
  },
  {
    id: 3,
    name: "Ask-Answer",
    ...
    description:
      "A Q&A platform designed for students and tutors to interact and exchange knowledge. Users can ask questions on any topic, and tutors can provide answers and explanations in a quick and easy manner. \n The app's user interface is intuitive and easy to navigate, with a search bar for users to find existing answers to similar questions. Users can also filter questions by subject or category to find specific topics they need help with.",
    stacks: ["python (flask)", "react", "postgres"],
  },
  {
    id: 4,
    ...
    description:
      "A platform shows the collection of a developer's code repositories hosted on GitHub. It serves as a showcase of the developer's skills, experience, and projects. The portfolio typically includes a README file, which contains a brief description of the developer's work and links to their projects.\n A GitHub portfolio can be customized to showcase a developer's best work, with the most relevant projects pinned to the top of their repository list. It can also include links to the developer's personal website, social media accounts, and resume.",
    stacks: ["vue", "github api", "vue-router", "vuex"],
  },
  {
    id: 5,
    name: "Opspad",
    ...
    description:
      "This is a software application designed to help system administrators manage and monitor one or more servers. The app provides a dashboard that displays real-time information about the server's performance, including CPU and memory usage, disk space, and network traffic.\n The app allows administrators to remotely access and manage the server, making it easy to troubleshoot issues, configure settings, and install updates. The app may also include features such as automated backups, disaster recovery, and security monitoring to ensure that the server remains secure and stable.",
    stacks: ["collaboration", "react", "redux"],
  },
  {
    id: 6,
    name: "FoodApp",
  ...
  },
  {
    ...
    stacks: ["nextjs", "rest countries api"],
  },
  {
    id: 8,
    name: "MySchool",
